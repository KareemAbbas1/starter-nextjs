...
async function handler(req, res) {
  ...
  await (0,_util_mongo__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(); // Fetch car by id
  ...
  if (method === "GET") {
    ...
    await _models_Car__WEBPACK_IMPORTED_MODULE_1__/* ["default"].findById */ .Z.findById(id).then(car => res.status(200).json(car));
  } // Update car


  if (method === "PATCH") {
    if (user.role !== "admin1" && user.role !== "admin2") throw (0,_middlewares_errorsMiddleware__WEBPACK_IMPORTED_MODULE_3__/* .createError */ .T)(403, "You are not authorized");
    await _models_Car__WEBPACK_IMPORTED_MODULE_1__/* ["default"].findByIdAndUpdate */ .Z.findByIdAndUpdate(id, {
      $set: req.body
    }, {
      new: true
  ...
  if (method === "DELETE") {
    if (user.role !== "admin1" && user.role !== "admin2") throw (0,_middlewares_errorsMiddleware__WEBPACK_IMPORTED_MODULE_3__/* .createError */ .T)(403, "You are not authorized");
    await _models_Car__WEBPACK_IMPORTED_MODULE_1__/* ["default"].findByIdAndDelete */ .Z.findByIdAndDelete(id).then(car => res.status(200).json("Car has been deleted"));
  }
}
...
var __webpack_exports__ = __webpack_require__.X(0, [7264], () => (__webpack_exec__(4518)));
