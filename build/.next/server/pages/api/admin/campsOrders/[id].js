...
/* harmony import */ var _models_CampOrder__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3551);
...
async function handler(req, res) {
  ...
  await (0,_util_mongo__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(); // Fetch Single Camp orders

  if (method === "GET") {
    const camp = await _models_Camp__WEBPACK_IMPORTED_MODULE_1__/* ["default"].findById */ .Z.findById(id);
    const ordersList = await Promise.all(camp.orders.map(orderId => {
      return _models_CampOrder__WEBPACK_IMPORTED_MODULE_2__/* ["default"].findById */ .Z.findById(orderId);
    }));
...
var __webpack_exports__ = __webpack_require__.X(0, [7264,5843], () => (__webpack_exec__(4825)));
