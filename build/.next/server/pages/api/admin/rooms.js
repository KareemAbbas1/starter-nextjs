...
async function handler(req, res) {
  ...
  await (0,_util_mongo__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(); // Get all rooms

  if (method === "GET") {
    await _models_Room__WEBPACK_IMPORTED_MODULE_1__/* ["default"].find */ .Z.find().then(rooms => res.status(200).json(rooms));
  } // Create new room


  if (method === "POST") {
    const newRoom = new _models_Room__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z(req.body);
...
var __webpack_exports__ = __webpack_require__.X(0, [7264], () => (__webpack_exec__(3198)));
