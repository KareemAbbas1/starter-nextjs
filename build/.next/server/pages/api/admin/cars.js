...
async function handler(req, res) {
  ...
  await (0,_util_mongo__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(); // Create new Car
  ...
  if (method === "POST") {
    ...
    await _models_Car__WEBPACK_IMPORTED_MODULE_1__/* ["default"].create */ .Z.create(req.body).then(car => res.status(201).json(car));
  }
}
...
var __webpack_exports__ = __webpack_require__.X(0, [7264], () => (__webpack_exec__(1300)));
