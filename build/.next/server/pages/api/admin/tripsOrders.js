...
async function handler(req, res) {
  ...
  if (user.role === "admin1" || user.role === "admin2") {
    ...
    if (method === "GET") {
      await _models_TripOrder__WEBPACK_IMPORTED_MODULE_1__/* ["default"].find */ .Z.find().sort({
        createdAt: -1
...
var __webpack_exports__ = __webpack_require__.X(0, [7264,8670], () => (__webpack_exec__(3087)));
