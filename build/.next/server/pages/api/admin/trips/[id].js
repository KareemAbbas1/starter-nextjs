...
async function handler(req, res) {
  ...
  await (0,_util_mongo__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(); // Update Trip
  ...
  if (method === "PATCH") {
    ...
    const updatedTrip = await _models_Trip__WEBPACK_IMPORTED_MODULE_1__/* ["default"].findByIdAndUpdate */ .Z.findByIdAndUpdate(id, {
      $set: req.body
    }, {
      new: true
    });
  ...
  if (method === "DELETE") {
    if (user.role !== "admin1" && user.role !== "admin2") throw (0,_middlewares_errorsMiddleware__WEBPACK_IMPORTED_MODULE_3__/* .createError */ .T)(403, "You are not authorized");
    await _models_Trip__WEBPACK_IMPORTED_MODULE_1__/* ["default"].findByIdAndDelete */ .Z.findByIdAndDelete(id);
...
var __webpack_exports__ = __webpack_require__.X(0, [7264,5200], () => (__webpack_exec__(8151)));
