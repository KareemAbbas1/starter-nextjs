...
async function handler(req, res) {
  ...
  await (0,_util_mongo__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(); // Change image
  ...
  if (method === "PATCH") {
    ...
    await _models_Image__WEBPACK_IMPORTED_MODULE_1__/* ["default"].findByIdAndUpdate */ .Z.findByIdAndUpdate(id, {
      $set: req.body
...
var __webpack_exports__ = __webpack_require__.X(0, [7264], () => (__webpack_exec__(4673)));
