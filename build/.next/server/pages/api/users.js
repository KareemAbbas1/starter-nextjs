...
async function handler(req, res) {
  ...
  if (user.role !== "admin1") throw (0,_middlewares_errorsMiddleware__WEBPACK_IMPORTED_MODULE_3__/* .createError */ .T)(403, "You are not authorized");

  if (method === "GET") {
    await _models_User__WEBPACK_IMPORTED_MODULE_1__/* ["default"].find */ .Z.find().then(users => res.status(200).json(users));
  }
}
...
var __webpack_exports__ = __webpack_require__.X(0, [7264], () => (__webpack_exec__(4293)));
